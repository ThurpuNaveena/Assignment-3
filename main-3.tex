...
\section{Solution}
\begin{align}
\vec{R} = \myvec{1\\1\\-1},\vec{S} = \myvec{6\\4\\-5} and \vec{T} = \myvec{-4\\-2\\3}
\end{align}
...
\begin{align}
\vec{n} &={\vec{(R-S)}\times\vec{(S-T)}}
\end{align}
The equation of the plane is then obtained from
\begin{align}
\vec{n}^T\brak{\vec{x}-\vec{T}} &= \vec{[(R-S)\times(S-T)]}^T\brak{\vec{x}-\vec{T}} &=0
\end{align}
